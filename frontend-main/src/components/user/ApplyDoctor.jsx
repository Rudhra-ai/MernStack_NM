...
function ApplyDoctor({ userId }) {
   ...
   const handleSubmit = async () => {
      ...
      try {
         const res = await axios.post('http://localhost:8000/api/user/registerdoc', { doctor }, {
            headers: {
         ...
         <Form onFinish={handleSubmit} className='m-3'>
            ...
            <Row gutter={20}>
               <Col xs={24} md={12} lg={8}>
                  <Form.Item label="Full Name" required className="form-label">
                     <Input name='fullName' value={doctor.fullName} onChange={handleChange} placeholder='Enter name' />
                  </Form.Item>
               </Col>
               <Col xs={24} md={12} lg={8}>
                  <Form.Item label="Phone" required className="form-label">
               ...
               <Col xs={24} md={12} lg={8}>
                  <Form.Item label="Address" required className="form-label">
